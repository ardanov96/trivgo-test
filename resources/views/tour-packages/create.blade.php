                ...
                <form action="{{ route('tour-packages.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="duration_days" name="duration_days" type="number" class="mt-1 block w-full" :value="old('duration_days')" required />
                            <x-input-error :messages="$errors->get('duration_days')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="max_participants" :value="__('Max Participants')" />
                            <x-text-input id="max_participants" name="max_participants" type="number" class="mt-1 block w-full" :value="old('max_participants')" required />
                    ...
                    <div class="mt-4 text-right">
                        <x-secondary-button onclick="history.back()" class="mr-2">Cancel</x-secondary-button>
